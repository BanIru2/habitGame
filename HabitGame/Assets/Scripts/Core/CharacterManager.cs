...
public class CharacterManager : Singleton<CharacterManager>
{
    ...
    public BattleUnit CreateBattleUnit(AttributeType selectedAttr)
    {
        int attrLevel = selectedAttr switch
        {
        ...
        return new BattleUnit
        {
            ...
            hp = characterStatusData.Hp,    
            atk = (int)characterStatusData.Atk,    // 타입 통일 필요 (float or int)
            def = (int)characterStatusData.Def,
            spd = (int)characterStatusData.Spd,
            crtk = characterStatusData.Crit,
